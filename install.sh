...
EOF
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/baimi-bm/testv2bx/master/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/baimi-bm/testv2bx/master/initconfig.sh
